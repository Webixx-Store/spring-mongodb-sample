        ...
        return new WebMvcConfigurer() {
            ...
            public void addCorsMappings(CorsRegistry registry) {
                registry.addMapping("/**") // Allow all endpoints
                        .allowedOrigins("http://localhost:4200" , "http://192.168.40.45:4200" , "http://localhost:4300" , "https://auth-webixx.web.app" , "https://dattot-vn.web.app") // Allow specific origin
