...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        registry.addEndpoint("/ws") // Endpoint cho server WebSocket
                .setAllowedOrigins("http://localhost:4200" , "https://dattot-vn.web.app" , "http://localhost:4300" , "https://auth-webixx.web.app" , "https://cryptovuive.web.app") // Chỉ định nguồn gốc cho phép kết nối
